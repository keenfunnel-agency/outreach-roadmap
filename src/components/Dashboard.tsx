        ...
        >
          <div className="rounded-2xl border border-slate-800/90 bg-slate-950/60 p-8">
            ...
            <div className="mt-6 h-1 w-full overflow-hidden rounded-full bg-slate-900">
              <div
                className="h-full rounded-full bg-gradient-to-r from-[#93ADFF]/20 to-[#93ADFF]"
          ...
          <div className="flex flex-col rounded-2xl border border-slate-800/90 bg-slate-950/60 p-6">
            <div className="text-[11px] tracking-[0.22em] text-[#93ADFF]">PILLAR RADAR</div>
              ...
              <ResponsiveContainer width="100%" height="100%">
                <RadarChart data={radarData} outerRadius="85%" margin={{ top: 24, right: 48, bottom: 24, left: 48 }}>
                  ...
                  <Radar
                    ...
                    fill="#93ADFF"
                    fillOpacity={0.3}
                    activeDot={{ fill: "#93ADFF", stroke: "#93ADFF" }}
                  />
                </RadarChart>
              </ResponsiveContainer>
            </div>
          ...
          {roadmap.length === 0 ? (
            ...
            <div className="overflow-hidden rounded-2xl border border-slate-800/90 bg-slate-950/60">
              <div className="border-b border-white/10 px-8 py-6">
                <div className="text-[11px] tracking-[0.22em] text-[#93ADFF]">
              ...
              <div className="divide-y divide-slate-800/70">
                {roadmap.map((r) => (
                  ...
                  >
                    ...
                    <div>
                      <div className="text-sm text-slate-100">{r.initiative}</div>
                    </div>
                    <div>
                        ...
                        {r.resources.map((res) => {
                          ...
                          return (
                            <button
                              ...
                              className="inline-flex items-center rounded-full border border-slate-700/80 bg-slate-800/70 px-3 py-1 text-[12px] font-medium text-[#93ADFF]/90 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] transition-all duration-200 hover:scale-105 hover:border-[#93ADFF]/50 hover:bg-slate-700 hover:text-[#93ADFF] focus:outline-none focus:ring-2 focus:ring-[#93ADFF]/40"
                            >
                              {res}
                            </button>
                          );
              ...
              <ol className="relative mt-10 space-y-10 pl-12">
                ...
                {phasePlan.segments.map((p, i) => (
                  <motion.li
                    ...
                    className="relative"
                  >
                    <div className="absolute -left-12 top-0 flex h-9 w-9 items-center justify-center rounded-[12px] bg-gradient-to-br from-[#93ADFF] to-[#778bca] shadow-[0_0_20px_-4px_rgba(147,173,255,0.6)]">
                    ...
                    <div className="flex flex-wrap items-baseline justify-between gap-2">
                      ...
                      <div className="bg-[linear-gradient(to_right,#DCC8F8,#FCFCBF,#FFD4F7,#C8DDFF,#B2E0FF,#9ABDFF,#93ADFF)] bg-clip-text text-sm font-semibold tracking-wide text-transparent">
                        {p.range}
                      </div>
                    </div>
